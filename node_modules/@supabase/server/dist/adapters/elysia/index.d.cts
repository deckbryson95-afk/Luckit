import { n as AuthError } from "../../errors-Ba4aA9Y_.cjs";
import { _ as UntypedDatabase, h as SupabaseContext, y as WithSupabaseConfig } from "../../types-D6AvzzRd.cjs";
 ...
 * @category Adapters
 */
declare function withSupabase<Database = UntypedDatabase>(config?: Omit<WithSupabaseConfig, 'cors'>): Elysia<'', {
  decorator: {};
  store: {};
  derive: {};
  resolve: {};
