import { b as MissingResourceServerError, c as Errors, m as MissingAuthorizationServerError, o as ErrorCodeHeader } from "./errors-DV038ZPa.mjs";
import { n as isConstructionFailure, r as markConstructionFailure, t as constructionFailureResponse } from "./construction-failure-Nq27zVpW.mjs";
import { defineMiddleware, getEnv, runtimeName } from "@supabase/middleware";
...
function edgeResourcePath(req) {
	...
	if (received === "" || received === "/") throw Errors[MissingResourceServerError](runtimeName);
...
function deriveDefault(req, fallback) {
	try {
		...
		throw error instanceof Error ? markConstructionFailure(error, "oauthProtectedResource") : error;
	}
}
/**
...
* ```
*/
const withOAuthProtectedResource = tagPreAuth(defineMiddleware({
		...
		try {
			...
			if (isConstructionFailure(error, "oauthProtectedResource")) {
				...
				if (isMetadataRoute) {
					...
					response.headers.set("Access-Control-Expose-Headers", ErrorCodeHeader);
				}
				return response;
			}
			throw error;
...
//#endregion
export { preAuthName as a, fromSupabaseUrl as i, resourceMetadataResponse as n, unauthorizedResponse as r, withOAuthProtectedResource as t };
