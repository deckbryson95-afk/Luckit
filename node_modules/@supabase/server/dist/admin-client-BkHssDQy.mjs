...
import { t as createAdminClient } from "./create-admin-client-Dkql77Y9.mjs";
	...
	run: (config) => async (_req, ctx) => {
		...
		return { supabaseAdmin: lazyClient(() => {
			try {
				...
				throw e instanceof EnvError ? e : Errors[CreateSupabaseClientError]({ cause: e });
			}
		}) };
	}
});
...
//#endregion
export { withSupabaseAdminClient as t };
