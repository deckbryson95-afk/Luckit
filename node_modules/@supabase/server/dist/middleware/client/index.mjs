import { c as Errors, i as EnvError, r as CreateSupabaseClientError } from "../../errors-DV038ZPa.mjs";
import { r as markConstructionFailure } from "../../construction-failure-Nq27zVpW.mjs";
import { t as extractCredentials } from "../../extract-credentials-BVHjxEOY.mjs";
import { t as readUpstreamAuth } from "../../read-upstream-auth-CErPqHki.mjs";
import { t as createContextClient } from "../../create-context-client-BHkTVgZV.mjs";
...
const base = defineMiddleware({
	...
	run: (config) => async (req, ctx) => {
		...
		try {
			...
			throw markConstructionFailure(e instanceof EnvError ? e : Errors[CreateSupabaseClientError]({ cause: e }), "supabase");
		}
		return { supabase };
	}
});
