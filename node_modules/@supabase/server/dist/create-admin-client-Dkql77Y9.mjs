import { c as Errors, v as MissingDefaultSecretKeyError, x as MissingSecretKeyError } from "./errors-DV038ZPa.mjs";
...
function createAdminClient(options) {
	...
	if (!secretKey) {
		...
		throw name === "default" ? Errors[MissingDefaultSecretKeyError](configuredKeyNames) : Errors[MissingSecretKeyError](name, configuredKeyNames);
	}
